# 🚗🔧 404-back 스마트 팩토리 - IoT 데이터 수집 시스템

제조 현장의 센서 데이터를 실시간으로 수집하고 모니터링하는 Flask 백엔드입니다.  
MQTT로 온도, 진동, 불량 감지 데이터를 받아 3-Tier 검증을 거친 후, WebSocket으로 대시보드에 즉시 전달합니다.  
Spring Boot 근태 서버와 함께 스마트 팩토리의 전체 백엔드를 구성합니다.
